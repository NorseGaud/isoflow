...
/** Read the raw IndexedDB SQLite blob for legacy server import. */
export const readLegacySqliteBlob = loadSqliteFile;

export const createIndexedDbAdapter = (): SqlitePersistenceAdapter => {
  return {
    load: loadSqliteFile,
    save: saveSqliteFile
  };
